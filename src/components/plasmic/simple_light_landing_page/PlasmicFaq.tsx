...
import sty from "./PlasmicFaq.module.css"; // plasmic-import: hDue7m2Ls4ua/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox___3D4Cd)}
      >
        <div className={classNames(projectcss.all, sty.freeBox___7Yd8E)}>
          <div className={classNames(projectcss.all, sty.freeBox___4Vd1K)}>
            {p.renderPlasmicSlot({
