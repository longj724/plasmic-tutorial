...
import Avatar from "../../Avatar"; // plasmic-import: zmgtIg-_MjV0/component
...
import sty from "./PlasmicTestimonial.module.css"; // plasmic-import: 0JnHKrbHXTc9/css

import QuoteDashesIcon from "./icons/PlasmicIcon__QuoteDashes"; // plasmic-import: Qu5fHz3UgL09f/icon
import profilepicLqTTvOoy28Mlv from "./images/profilepic.png"; // plasmic-import: lqTTvOOY28mlv/picture
  ...
  return (
    ...
    >
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__jGWdu)}
      >
        <div
          className={classNames(
            projectcss.all,
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox___4Jq3G)}
        >
          <div
            className={classNames(
              projectcss.all,
