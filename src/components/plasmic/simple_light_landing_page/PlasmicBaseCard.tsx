...
import sty from "./PlasmicBaseCard.module.css"; // plasmic-import: l50DTMfEuJ6O/css
...
function PlasmicBaseCard__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(projectcss.all, sty.freeBox___6Uvn, {
          [sty.freeBoxlong___6UvnVabIe]: hasVariant($state, "long", "long")
        })}
      >
        {p.renderPlasmicSlot({
          defaultContents:
      ...
      {(hasVariant($state, "long", "long") ? true : true) ? (
        <div
          className={classNames(projectcss.all, sty.freeBox__kcZE, {
            [sty.freeBoxlong__kcZEvabIe]: hasVariant($state, "long", "long")
          })}
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__kuBuO)}
                role={"img"}
              />
            ),
