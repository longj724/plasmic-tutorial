...
import sty from "./PlasmicFeatureCard.module.css"; // plasmic-import: TZU1tij1E2FO/css
  ...
  return (
    ...
    >
      {(hasVariant($state, "long", "long") ? true : true) ? (
        <div
          className={classNames(projectcss.all, sty.freeBox__dLmU, {
            [sty.freeBoxlong__dLmUmx6Xi]: hasVariant($state, "long", "long")
          })}
        >
          <div
            className={classNames(projectcss.all, sty.freeBox__oKo7B, {
              [sty.freeBoxlong__oKo7Bmx6Xi]: hasVariant($state, "long", "long")
            })}
          >
            {p.renderPlasmicSlot({
              defaultContents: (
                <svg
                  className={classNames(projectcss.all, sty.svg__fl0Nz)}
                  role={"img"}
                />
              ),
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__s55Oo, {
          [sty.freeBoxlong__s55Oomx6Xi]: hasVariant($state, "long", "long")
        })}
      >
        {p.renderPlasmicSlot({
      ...
      {(hasVariant($state, "long", "long") ? true : true) ? (
        <div
          className={classNames(projectcss.all, sty.freeBox__bgGdh, {
            [sty.freeBoxlong__bgGdhmx6Xi]: hasVariant($state, "long", "long")
          })}
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__oZrMj)}
                role={"img"}
              />
            ),
